// This file is the one place where the backend decides:
// "Where do we store things on disk?" and "How do we talk to SQLite?"
...
export function ensureDataDirectory(directoryName?: string): string {
  if (typeof require === "undefined") {
...
function createDatabase(): SqliteDatabase | null {
  if (typeof require === "undefined" || typeof process === "undefined" || typeof process.cwd !== "function") {
    return null;
  }
...
export function getPersistencePath(): string | null {
  if (typeof require === "undefined") {
    return null;
  }
